...
int main( int argc, char * argv[] )
{
  ...
  tipo_lista lista = crear( );
	...
	printf("reemplazo el elemento en la posición 2 por 9:\n");
	
	printf("elemento reemplazado: %d\n", reemplazar(lista, 9, 2));
  ...
  printf("Intercambio el elemento en la posición 0 con el elemento en la última posición:\n");

  intercambiar(lista, 0, 4);
