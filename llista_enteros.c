...
int ins( tipo_lista lista, int elemento, int posicion){
	...
	if ( !posicion ){               //Si la posición es 0
...
int eliminar( tipo_lista lista, int posicion){
	...
	if ( !posicion ){              //Si la posición en 0
...
void intercambiar(tipo_lista lista, int p1, int p2){
	...
	j = obtener(lista, p1); //j tiene el elem de la posición p1
	k = obtener(lista, p2); //k tiene el elem de la posición p2

    reemplazar(lista, k, p1); //reemplazo el elem en la posición p1 por k (elem de p2)
    reemplazar(lista, j, p2); //reemplazo el elem en la posicoón p2 por j (elem de p1)
}